...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FUNCS] = LAYOUT(
      ...
      _______, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_BRIU, KC_MUTE, KC_VOLD, XXXXXXX, XXXXXXX,  _______,
      _______, KC_F11, KC_F12, KC_F13, KC_F14, KC_F15,  _______, XXXXXXX, XXXXXXX, _______, KC_BRID, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, _______,
